...
export default function MobileMenu() {
  return (
    <nav className={styles.nav}>
      <Item label="explore" highlighted>
        <ExploreIcon size={24} />
      </Item>
...
const Item = ({ label, highlighted, children }: Props) => (
  <div aria-label={label.toLowerCase()} className={styles.item}>
    <div className={styles.icon}>{children}</div>
    <span
      className={[
        styles.label,
        highlighted ? styles.label_highlighted : "",
      ].join(" ")}
    >
